...
namespace AssignManipJagArray
{
    internal class Program
    {
        ...
        static double CalculateOverallAverage(int[][] studentScores)
        {
            ...
            {
                totalScores += scores.Sum(); // Sum up all the scores for each student
                totalStudents += scores.Length; // Increment totalStudents by the number of students
            }
